...
from app.schemas import LoginRequest, RegisterRequest, TokenResponse, UserOut, WalletUpdate
...
def update_wallet(
    ...
    """Link a real MetaMask address so this account's NFTs are viewable in their own wallet."""
